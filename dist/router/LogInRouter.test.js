...
describe("Testing for /auth logout", () => {
    it("GET request to /auth", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(server_1.app).get("/auth/logout");
        expect(res.statusCode).toEqual(200);
    }));
    it("POST request to /auth general login", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(server_1.app).post("/auth/login");
        expect(res.statusCode).toEqual(201);
    }));
    it("POST request to /auth admin", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(server_1.app).put("/auth/admin-login");
        expect(res.statusCode).toEqual(201);
    }));
});
