...
describe("Testing for /order", () => {
    it("GET request to /order", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(server_1.app).get("/order");
        expect(res.statusCode).toEqual(200);
    }));
    it("POST request to /order", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(server_1.app).post("/order");
        expect(res.statusCode).toEqual(201);
    }));
    it("PUT request to /order", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(server_1.app).put("/order");
        expect(res.statusCode).toEqual(201);
    }));
});
