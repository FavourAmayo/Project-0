...
describe("Testing for /user", () => {
    it("GET request to /user", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(server_1.app).get("/user");
        expect(res.statusCode).toEqual(200);
    }));
    it("POST request to /user", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(server_1.app).post("/user");
        expect(res.statusCode).toEqual(201);
    }));
    it("PUT request to /user", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield request(server_1.app).put("/user");
        expect(res.statusCode).toEqual(201);
    }));
});
